...
lendf<-length(z_all)*length(nsplist)*length(rholist)
...
pdf("../../Results/Prelim_res_plot/conceptual_fig2stability_with_interaction.pdf", width = 10, height = 6)
g1
dev.off()
