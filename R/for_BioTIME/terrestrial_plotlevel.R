...
source("terrestrial_plotlevel_39.R") # no site found
...
source("terrestrial_plotlevel_243.R")# no site found
...
source("terrestrial_plotlevel_538.R")# no plots have >=15 sp.
...
df_included<-df%>%filter(site%notin%c(39,46,47,54,56,59,63,67,
                                      195,214,221,243,298,
                                      300,301,308,311,
                                      356,360,361,363,366,
                                      413,414, 416,420,483,497,
