...
df<-df%>%filter(site==360)
#----------- create result folder for wrangle data -------------------------
resloc<-"../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/360/"
...
for(k in 1:length(newsite)){
  resloc2<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/360/",newsite[k],"/",sep="")
...
for(k in 1:length(newsite)){
  ...
  resloc<-paste("../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/360/",newsite[k],"/",sep="")
...
saveRDS(newsite,"../../DATA/for_BioTIME/wrangled_data/Terrestrial_plotlevel/360/newsite.RDS")